...
MRMV_model=read.csv("./table1_MRMV.csv", row.names = NULL)
MRMV_IVW_model=read.csv("./table1_MRMV_IVW.csv", row.names = NULL)
MRMV_MEDIAN_model=read.csv("./table1_MRMV_MEDIAN.csv", row.names = NULL)
MMR_2stage_model=read.csv("./table1_TS_LMM.csv", row.names = NULL)
presso_model=read.csv("./table1_presso.csv", row.names = NULL)

##output the main table

scenario=cbind(1,0,-1)  ##no need to change this variable
