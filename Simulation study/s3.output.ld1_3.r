...
MRMV_model=read.csv("./ld1_noP_table1_MRMV.csv", row.names = NULL)[1:read_row,]
MRMV_IVW_model=read.csv("./ld1_noP_table1_MRMV_IVW.csv", row.names = NULL)[1:read_row,]
MMR_2stage_model=read.csv("./ld1_noP_table1_TS_LMM.csv", row.names = NULL)[1:read_row,]
scenario=cbind(0.1,0,-0.1)  

MRMV_model=read.csv("./ld1_BP_table1_MRMV.csv", row.names = NULL)[1:read_row,]
MRMV_IVW_model=read.csv("./ld1_BP_table1_MRMV_IVW.csv", row.names = NULL)[1:read_row,]
MMR_2stage_model=read.csv("./ld1_BP_table1_TS_LMM.csv", row.names = NULL)[1:read_row,]
scenario=cbind(0.3,0,-0.3)  

MRMV_model=read.csv("./ld1_UBP_table1_MRMV.csv", row.names = NULL)[1:read_row,]
MRMV_IVW_model=read.csv("./ld1_UBP_table1_MRMV_IVW.csv", row.names = NULL)[1:read_row,]
MMR_2stage_model=read.csv("./ld1_UBP_table1_TS_LMM.csv", row.names = NULL)[1:read_row,]
scenario=cbind(0.1,0,-0.1)  

MRMV_model=read.csv("./ld3_noP_table1_MRMV.csv", row.names = NULL)[1:read_row,]
MRMV_IVW_model=read.csv("./ld3_noP_table1_MRMV_IVW.csv", row.names = NULL)[1:read_row,]
MMR_2stage_model=read.csv("./ld3_noP_table1_TS_LMM.csv", row.names = NULL)[1:read_row,]
scenario=cbind(0.1,0,-0.1)  

MRMV_model=read.csv("./ld3_BP_table1_MRMV.csv", row.names = NULL)[1:read_row,]
MRMV_IVW_model=read.csv("./ld3_BP_table1_MRMV_IVW.csv", row.names = NULL)[1:read_row,]
MMR_2stage_model=read.csv("./ld3_BP_table1_TS_LMM.csv", row.names = NULL)[1:read_row,]
scenario=cbind(0.3,0,-0.3) 

MRMV_model=read.csv("./ld3_UBP_table1_MRMV.csv", row.names = NULL)[1:read_row,]
MRMV_IVW_model=read.csv("./ld3_UBP_table1_MRMV_IVW.csv", row.names = NULL)[1:read_row,]
MMR_2stage_model=read.csv("./ld3_UBP_table1_TS_LMM.csv", row.names = NULL)[1:read_row,]
scenario=cbind(0.1,0,-0.1)  
