...
source('./simulation.v2/s1.data.ld0.UBP.r')
...
write.csv(MRMV_MEDIAN_model,"./simulation.v2/results/UBP_table1_MRMV_MEDIAN.csv")
write.csv(MMR_2stage_model,"./simulation.v2/results/UBP_table1_TS_LMM.csv")
write.csv(presso_model,"./simulation.v2/results/UBP_table1_presso.csv")
