  ...
  
{
  ...
  source('./simulation.v2/s1.data.ld0.BP.r')
...
write.csv(MRMV_model,"./simulation.v2/results/BP_table1_MRMV.csv")
write.csv(MRMV_IVW_model,"./simulation.v2/results/BP_table1_MRMV_IVW.csv")
write.csv(MRMV_MEDIAN_model,"./simulation.v2/results/BP_table1_MRMV_MEDIAN.csv")
write.csv(MMR_2stage_model,"./simulation.v2/results/BP_table1_TS_LMM.csv")
write.csv(presso_model,"./simulation.v2/results/BP_table1_presso.csv")

write.csv(IV_con_strength,"./simulation.v2/results/BP_table1_IV_con.csv")
write.csv(IV_strength,"./simulation.v2/results/BP_table1_IV.csv")
write.csv(incept_pvalue,"./simulation.v2/results/BP_incept_pvalue.csv")
